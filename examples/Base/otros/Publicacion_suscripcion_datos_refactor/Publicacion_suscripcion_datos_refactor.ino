...
#define TOPIC_TEMP "sensores/temperatura/0"
#define TOPIC_PRES "sensores/presion/0"
#define TOPIC_HUM "sensores/humedad/0"
...
void loop() {
   if((millis()-ultima_medida)>intervalo)    {
    ...
    Ciao.write(CONNECTOR, TOPIC_TEMP, String(temp)); // pushes data into a channel called PIN_A1
    Ciao.write(CONNECTOR, TOPIC_PRES, String(pres)); // pushes data into a channel called PIN_A1
    Ciao.write(CONNECTOR, TOPIC_HUM, String(hum)); // pushes data into a channel called PIN_A1
